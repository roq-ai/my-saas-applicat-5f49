...
import { getCarbonData, deleteCarbonDataById } from 'apiSdk/carbon-data';
...
function CarbonDataListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('carbon_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/carbon-data/view/${id}`);
    }
  };
  ...
  return (
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('carbon_data', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            <Text as="h1" fontSize="2xl" fontWeight="bold">
              Carbon Data
            </Text>
            <NextLink href={`/carbon-data/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('carbon_data', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/carbon-data/edit/${record.id}`} passHref legacyBehavior>
                          <Button
