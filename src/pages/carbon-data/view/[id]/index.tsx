...
import { getCarbonDataById } from 'apiSdk/carbon-data';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Carbon Data Detail View
          </Text>
          {hasAccess('carbon_data', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/carbon-data/edit/${data?.id}`} passHref legacyBehavior>
              <Button
