...
import { getCarbonGoals, deleteCarbonGoalById } from 'apiSdk/carbon-goals';
...
function CarbonGoalListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('carbon_goal', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/carbon-goals/view/${id}`);
    }
  };
  ...
  return (
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('carbon_goal', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            <Text as="h1" fontSize="2xl" fontWeight="bold">
              Carbon Goal
            </Text>
            <NextLink href={`/carbon-goals/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('carbon_goal', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/carbon-goals/edit/${record.id}`} passHref legacyBehavior>
                          <Button
