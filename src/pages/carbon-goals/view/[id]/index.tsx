...
import { getCarbonGoalById } from 'apiSdk/carbon-goals';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Carbon Goal Detail View
          </Text>
          {hasAccess('carbon_goal', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/carbon-goals/edit/${data?.id}`} passHref legacyBehavior>
              <Button
